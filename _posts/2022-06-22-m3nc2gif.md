...
key: 20220622
lang: zh-TW
tags: python wrf graphics netCDF matplotlib wrf-python
---
...
- 畫等值線圖對matplotlib不是問題，但因為座標投影的問題，很容易發生位置扭曲的情形，還是需要用經緯度來校正。這也是[wrf-python](https://sinotec2.github.io/Focus-on-Air-Quality/utilities/Graphics/wrf-python/1.basic/)的強項。麻煩的是必須從wrf_out來讀取座標系統的轉換參數。
