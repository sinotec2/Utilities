...
- Josh Illes(2020) [[[2024-01-11]]](https://joshilles.com/server/jekyll/gitea-drone-docker/)這個實例是用docker來布建所有的系統，包括[Gitea](https://about.gitea.com/)伺服器與[Drone](https://www.drone.io/)環境設定。  
